 ...
 * @since 2019-09-25
 */
@Api(tags = "TJobAuditLogController")
@RestController
@RequestMapping("/TJobAuditLogController")
public class TJobAuditLogController {
    @Autowired
    private TJobAuditLogService targetService;
    ...
    public BaseResp findAll() {
        List<TJobAuditLogEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TJobAuditLogEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TJobAuditLogEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TJobAuditLogEntity entity) {
