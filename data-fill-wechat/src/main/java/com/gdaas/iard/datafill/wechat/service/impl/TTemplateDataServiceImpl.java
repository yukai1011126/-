...
import com.gdaas.iard.datafill.wechat.repo.dao.mapper.TTemplateDataDao;
 ...
 */
@Service
public class TTemplateDataServiceImpl extends AbstractBaseService<TTemplateDataDao, TTemplateDataEntity>
        implements TTemplateDataService {
}
