...
import com.gdaas.iard.datafill.wechat.service.TDictIndexService;
 ...
 * @since 2019-09-30
 */
@Api(tags = "TDictIndexController")
@RestController
@RequestMapping("/TDictIndexController")
public class TDictIndexController {
    @Autowired
    private TDictIndexService targetService;
    ...
    public BaseResp findAll() {
        List<TDictIndexEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TDictIndexEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TDictIndexEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TDictIndexEntity entity) {
