 ...
 * @since 2019-09-25
 */
@Api(tags = "TJobAreaController")
@RestController
@RequestMapping("/TJobAreaController")
public class TJobAreaController {
    @Autowired
    private TJobAreaService targetService;
    ...
    public BaseResp addItem(@RequestBody TJobAreaEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TJobAreaEntity entity) {
