...
@Log4j2
@CrossOrigin
@Api(tags = "TTaskAuditLogController")
@RestController
@RequestMapping("/TTaskAuditLogController")
public class TTaskAuditLogController {
    @Autowired
    private TTaskAuditLogService targetService;
    ...
    public BaseResp findAll() {
        List<TTaskAuditLogEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TTaskAuditLogEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TTaskAuditLogEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TTaskAuditLogEntity entity) {
