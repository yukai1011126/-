...
import com.gdaas.iard.datafill.admin.service.TTaskAreaService;
import com.gdaas.iard.datafill.admin.repo.dao.entity.TTaskAreaEntity;
...
@Log4j2
@CrossOrigin
@Api(tags = "TTaskAreaController")
@RestController
@RequestMapping("/TTaskAreaController")
public class TTaskAreaController {
    @Autowired
    private TTaskAreaService targetService;
    ...
    public BaseResp findAll() {
        List<TTaskAreaEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TTaskAreaEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TTaskAreaEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TTaskAreaEntity entity) {
