...
import com.gdaas.iard.datafill.admin.service.TCommAreaService;
import com.gdaas.iard.datafill.admin.repo.dao.entity.TCommAreaEntity;
...
@Log4j2
@CrossOrigin
@Api(tags = "TCommAreaController")
@RestController
@RequestMapping("/TCommAreaController")
public class TCommAreaController {
    @Autowired
    private TCommAreaService targetService;
    ...
    public BaseResp findAll() {
        List<TCommAreaEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TCommAreaEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TCommAreaEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TCommAreaEntity entity) {
