 ...
 * @since 2019-10-05
 */
@Api(tags = "TTaskController")
@RestController
@RequestMapping("/TTaskController")
public class TTaskController {
    ...
    public BaseResp findAll() {
        List<TTaskEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TTaskEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TTaskEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TTaskEntity entity) {
