...
import com.gdaas.iard.datafill.admin.service.TTemplateTaskService;
import com.gdaas.iard.datafill.admin.repo.dao.entity.TTemplateTaskEntity;
 ...
 * @since 2019-10-05
 */
@Api(tags = "TTemplateTaskController")
@RestController
@RequestMapping("/TTemplateTaskController")
public class TTemplateTaskController {
    @Autowired
    private TTemplateTaskService targetService;
    ...
    public BaseResp findAll() {
        List<TTemplateTaskEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TTemplateTaskEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TTemplateTaskEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TTemplateTaskEntity entity) {
