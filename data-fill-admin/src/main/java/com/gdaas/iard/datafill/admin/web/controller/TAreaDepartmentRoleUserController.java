...
import com.gdaas.iard.datafill.admin.service.TAreaDepartmentRoleUserService;
import com.gdaas.iard.datafill.admin.repo.dao.entity.TAreaDepartmentRoleUserEntity;
...
public class TAreaDepartmentRoleUserController {
    @Autowired
    private TAreaDepartmentRoleUserService targetService;
    ...
    public BaseResp findAll() {
        List<TAreaDepartmentRoleUserEntity> models = targetService.list(null);
    ...
    public BaseResp find(Long id) {
        TAreaDepartmentRoleUserEntity entity = targetService.getById(id);
        if (entity == null) {
    ...
    public BaseResp addItem(@RequestBody TAreaDepartmentRoleUserEntity entity) {
    ...
    public BaseResp updateItem(@RequestBody TAreaDepartmentRoleUserEntity entity) {
